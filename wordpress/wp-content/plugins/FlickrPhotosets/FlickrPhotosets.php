...
function flickr_photosets_add_css_js($posts, $force = FALSE){
  global $flickr_gallery_shortcode; // im bad. punish me
	...
	if ($shortcode_found) {
		...
		wp_enqueue_script('jquery-scrollTo', plugins_url('jquery.scrollTo-1.4.2-min.js', __FILE__), array('jquery'));
		wp_enqueue_script('flickr-browser', plugins_url('flickrbrowser.js', __FILE__), array('jquery-fancybox','jquery-hashchange', 'jquery-scrollTo'));
