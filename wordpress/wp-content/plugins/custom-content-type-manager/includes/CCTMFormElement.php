...
abstract class CCTMFormElement {
	 ...
	 * @param string  $class (optional) Optional CSS class to further define the wrapper <div>
	 ...
	 *
	 * @param string  $additional_class (optional) any extra CSS class(es) you want to pass to this label
