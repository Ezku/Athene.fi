<div class="panel-display 960-16-394-leftSb container_16" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>

	<div class="grid_3">
	  
	  <?php if (!empty($content['leftSb'])): ?>
	  <div id="panel-leftSb" class="panel-panel panel-col-first grid_3">
	...
	<div class="grid_13">
	  ...
	  <div id="panel-top" class="panel-panel panel-col-last grid_13">
	  ...
	  <div id="panel-aboveLeft" class="panel-panel panel-col grid_9">
	  ...
	  <div id="panel-middle" class="panel-panel panel-col-last grid_13">
	  ...
	  <div id="panel-belowLeft" class="panel-panel panel-col grid_9">
	  ...
	  <div id="panel-bottom" class="panel-panel panel-col-last grid_13">
