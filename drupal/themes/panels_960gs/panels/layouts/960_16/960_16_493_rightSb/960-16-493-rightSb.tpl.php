<div class="panel-display 960-16-493-rightSb container_16" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>

  <div class="grid_13">
  
    <?php if (!empty($content['top'])): ?>
    <div id="panel-top" class="panel-panel panel-col-first grid_13">
    ...
    <div id="panel-aboveRight" class="panel-panel panel-col grid_9">
    ...
    <div id="panel-middle" class="panel-panel panel-col-first grid_13">
    ...
    <div id="panel-belowRight" class="panel-panel panel-col grid_9">
    ...
    <div id="panel-bottom" class="panel-panel panel-col-first grid_13">
  ...
  <div class="grid_3">
    ...
    <div id="panel-rightSb" class="panel-panel panel-col-last grid_3">
