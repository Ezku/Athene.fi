<div class="panel-display 960-16-493 container_16" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  ...
  <div id="panel-aboveCenter" class="panel-panel panel-col grid_9">
    <?php print $content['aboveCenter']; ?>
  </div>
  <?php endif; ?>

  <?php if (!empty($content['aboveRight'])): ?>
  <div id="panel-aboveRight" class="panel-panel panel-col-last grid_3">
  ...
  <div id="panel-belowCenter" class="panel-panel panel-col grid_9">
    <?php print $content['belowCenter']; ?>
  </div>
  <?php endif; ?>

  <?php if (!empty($content['belowRight'])): ?>
  <div id="panel-belowRight" class="panel-panel panel-col-last grid_3">
