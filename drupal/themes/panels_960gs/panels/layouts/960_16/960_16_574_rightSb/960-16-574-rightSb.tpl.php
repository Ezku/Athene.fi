<div class="panel-display 960-16-574-rightSb container_16" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
	...
	<div class="grid_12">
	  ...
	  <div id="panel-aboveLeft" class="panel-panel panel-col-first grid_5">
		<?php print $content['aboveLeft']; ?>
	  </div>
	  <?php endif; ?>

	  <?php if (!empty($content['aboveRight'])): ?>
	  <div id="panel-aboveRight" class="panel-panel panel-col grid_7">
	  ...
	  <div id="panel-belowLeft" class="panel-panel panel-col-first grid_5">
		<?php print $content['belowLeft']; ?>
	  </div>
	  <?php endif; ?>

	  <?php if (!empty($content['belowRight'])): ?>
	  <div id="panel-belowRight" class="panel-panel panel-col grid_7">
