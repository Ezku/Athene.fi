<div class="panel-display 960-16-466-leftSb container_16" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
	...
	<div class="grid_12">
	  ...
	  <div id="panel-aboveLeft" class="panel-panel panel-col grid_6">
		<?php print $content['aboveLeft']; ?>
	  </div>
	  <?php endif; ?>

	  <?php if (!empty($content['aboveRight'])): ?>
	  <div id="panel-aboveRight" class="panel-panel panel-col-last grid_6">
	  ...
	  <div id="panel-belowLeft" class="panel-panel panel-col grid_6">
